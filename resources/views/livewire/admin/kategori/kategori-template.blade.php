                        ...
                        <tr style="background: #ffffff; border-bottom: 1px solid #e5e7eb; transition: background-color 0.25s ease-in-out;"
                            ...
                            <td style="padding: 0.75rem 1rem; text-align: center;">
                                <div style="display: flex; justify-content: center; gap: 0.5rem;">
                                    <!-- Tombol Edit -->
                                    <button type="button" class="btn btn-primary"wire:click="$dispatch('edit', {{ $kategori }})"
                                    ...
                                    <!-- Tombol Hapus -->
                                    <button type="button" class="btn btn-primary" wire:click="confirmDelete({{ $kategori->id }})"
                        ...
                        <tr>
                            <td colspan="4"
                                ...
                                <div style="display: flex; flex-direction: column; align-items: center; gap: 1rem;">
                                    ...
                                    <div class="fw-semibold text-muted">Kategori tidak ditemukan.</div>
                                    <div class="small text-secondary">Belum ada data kategori untuk ditampilkan.</div>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button wire:click="resetNamaKategori" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus kategori
                    <strong>{{ $nama_kategoriBeingDeleted ?? '...' }}</strong>?
                </div>
                <div class="modal-footer">
                    <button wire:click="resetNamaKategori" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-danger" wire:click.prevent="delete">Hapus</button>
                </div>
            </div>
        </div>
    </div>
