    ...
    <div style="background: linear-gradient(135deg, #1e293b 0%, #334155 100%); border-radius: 12px; padding: 32px; color: white; box-shadow: 0 4px 25px rgba(30, 41, 59, 0.15); margin-bottom: 24px;">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-4 text-start mb-3 mb-md-0">
                <h1 style="font-size: 1.875rem; font-weight: 700; margin: 0 0 8px 0; letter-spacing: -0.025em;">Daftar akun Pengguna</h1>
                <p style="opacity: 0.8; margin: 0; font-size: 1rem; color: #cbd5e1;">Lihat dan kelola seluruh pengguna sistem.</p>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    @forelse ($users as $index => $user)
                        <tr style="background: #ffffff; border-bottom: 1px solid #e5e7eb; transition: background-color 0.25s ease-in-out;"
                            ...
                            <td style="padding: 0.75rem 1rem; color: #6b7280; font-size: 0.875rem;">{{ $user->email }}
                            </td>

                            <td style="padding: 0.75rem 1rem; text-align: center; vertical-align: middle;">
                                <span
                                    style="
                                               @if ($user->role === 'admin') background: linear-gradient(135deg, #7c3aed 0%, #4b5563 100%);
                                              @elseif($user->role === 'user')
                                                 background: linear-gradient(135deg, #6bbf94 0%, #3a6f60 100%); @endif
                                        color: white; 
                                        padding: 0.4rem 1rem; 
                                        border-radius: 8px; 
                                        font-size: 0.8rem; 
                            ...
                            <td style="padding: 0.75rem 1rem; text-align: center;">
                                <div style="display: flex; justify-content: center; gap: 0.5rem;">
                                    <button wire:click="$dispatch('edit', {{ $user }})"
                        ...
                        <tr>
                            <td colspan="6"
                                ...
                                <div style="display: flex; flex-direction: column; align-items: center; gap: 1rem;">
                                    ...
                                    <div class="small text-secondary">Belum ada data untuk ditampilkan di tabel ini.
                                    </div>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus akun : <strong> {{ $userBeingDeleted?->email ?? '' }}?</strong>
                </div>
