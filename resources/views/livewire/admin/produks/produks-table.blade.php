<div class="tw-container tw-w-full tw-p-6 tw-space-y-6 tw-mx-auto">
                        ...
                        <tr style="background: #ffffff; border-bottom: 1px solid #e5e7eb; transition: background-color 0.25s ease-in-out;"
                            ...
                            <td style="padding: 0.75rem 1rem; text-align: center;">
                                <div style="display: flex; justify-content: center; gap: 0.5rem;">
                                    ...
                                    <a href="{{ route('admin.produks.detail', $produk->id) }}" wire:navigate
                                        style="background: linear-gradient(135deg, #10b981 0%, #14b8a6 100%); border: none; color: white; padding: 0.625rem; border-radius: 8px; cursor: pointer; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 4px rgba(59,130,246,0.2);"
                        ...
                        <tr>
                            <td colspan="6"
                                ...
                                <div style="display: flex; flex-direction: column; align-items: center; gap: 1rem;">
                                    ...
                                    <div class="fw-semibold text-muted">Produk Tidak ditemukan.</div>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
        @livewire('admin.produks.create')
    </div>

    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        @livewire('admin.produks.edit')
    </div>
